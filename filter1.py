...
if __name__=='__main__':
    ...
    common_path = '/Users/apple/Documents/samananthar/filter1/en-'
    ...
    savefile_1 = common_path+languages+'/clean_en_'+languages+'_filter1.txt'
    savefile_2 = common_path+languages+'/clean_'+languages+'_en_filter1.txt'
    ...
    with open(savefile_1,"r") as f:
        print('./clean_en_'+languages+'_filter1.txt', len(f.readlines()))  # This would give length of files.

    with open(savefile_2,"r") as f1:
        print('./clean_'+languages+'_en_filter1.txt', len(f1.readlines()))  # This would give length of files.
